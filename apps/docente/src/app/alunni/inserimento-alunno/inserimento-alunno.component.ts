...
import { AlunniBackService, AuthService } from '@istruzione/shared/registro';
import { Router } from '@angular/router';

@Component({
  selector: 'istruzione-insert-alunno',
  templateUrl: './inserimento-alunno.component.html',
  styleUrls: ['./inserimento-alunno.component.scss'],
})
export class InserimentoAlunnoComponent {
