...
import { AlunniBackService, CorsoService, PagelleService } from '@istruzione/shared/registro';
...
export class PagellaPresideComponent {
  ...
  constructor(
    private corsi: CorsoService,
    private pag: PagelleService,
    private al: AlunniBackService
  ) {}
